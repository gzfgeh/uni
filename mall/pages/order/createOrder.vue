	...
	<view>
		...
		<view class="goods-section">
			...
			<view class="g-item">
				...
				<view class="right">
					<text class="title clamp">韓版於是洞洞拖鞋 夏季浴室防滑簡約居家【新人專享，限選意見】</text>
					<text class="spec">春裝款 L</text>
					<view class="price-box">
						<text class="price"> $17.8</text>
						<text class="number">x 1</text>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b" @click="toggleMask('show')">
				...
				<text class="cell-tit clamp">優惠券</text>
			...
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tit clamp">商家促銷</text>
				<text class="cell-tip disabled">暫無可用優惠</text>
			</view>
		</view>
		<!-- 金额明细 -->
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">商品金額</text>
				<text class="cell-tip"> $179.88</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">優惠金額</text>
				<text class="cell-tip red">- $35</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">運費</text>
				<text class="cell-tip">免運費</text>
			</view>
			<view class="yt-list-cell desc-cell">
				<text class="cell-tit clamp">備註</text>
				<input class="desc" type="text" v-model="desc" placeholder="請填寫備註信息" placeholder-class="placeholder" />
			</view>
		</view>
		...
		<view class="footer">
			...
			<text class="submit" @click="submit">提交訂單</text>
		</view>
