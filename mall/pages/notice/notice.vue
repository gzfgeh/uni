<template>
	<view>
		<view class="notice-item">
			...
			<view class="content">
				<text class="title">新品上市，全場滿199減50</text>
				...
				<text class="introduce">
					雖然做了壹件好事，但很有可能因此招來他人的無端猜測，例如被質疑是否藏有其他利己動機等，乃至譴責。即便如此，還是要做好事。
				</text>
				<view class="bot b-t">
					<text>查看詳情</text>
		...
		<view class="notice-item">
			...
			<view class="content">
				...
				<text class="introduce">新品上市全場2折起，新品上市全場2折起，新品上市全場2折起，新品上市全場2折起，新品上市全場2折起</text>
				<view class="bot b-t">
					<text>查看詳情</text>
					<text class="more-icon yticon icon-you"></text>
				</view>
