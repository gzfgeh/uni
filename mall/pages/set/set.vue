<template>
	<view class="container">
		<view class="list-cell b-b m-t" @click="navTo('個人資料')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">個人資料</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
		<view class="list-cell b-b" @click="navTo('收貨地址')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">收貨地址</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
		<view class="list-cell" @click="navTo('實名認證')" hover-class="cell-hover" :hover-stay-time="50">
		...
		<view class="list-cell">
			...
			<text class="cell-tip">當前版本 1.0.3</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
