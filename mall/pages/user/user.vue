    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				...
				<view class="info-box">
					<text class="username">{{userInfo.nickname || '遊客'}}</text>
				</view>
			</view>
			<view class="vip-card-box">
				...
				<text class="e-m">陽信商店街 VIP</text>
				<text class="e-b">開通會員</text>
			</view>
		</view>
		...
		>
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-shezhi1" iconColor="#e07472" title="設置" border="" @eventClick="navTo('/pages/set/set')"></list-cell>
			</view>
		</view>
