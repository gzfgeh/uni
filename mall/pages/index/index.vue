<template>
	<view class="container">
		...
		<view class="mp-search-box">
			<input class="ser-input" type="text" value="輸入關鍵字搜索" disabled />
		</view>
		<!-- #endif -->
		...
		<view class="carousel-section">
			...
			<swiper class="carousel" circular @change="swiperChange">
				<swiper-item v-for="(item, index) in carouselList" :key="index" class="carousel-item" @click="navToDetailPage({title: '輪播廣告'})">
					<image :src="item.src" />
				</swiper-item>
			</swiper>
			<!-- 自定義swiper指示器 -->
		...
		<view class="cate-section">
			...
			<view class="cate-item">
				<image src="/static/temp/c2.jpg"></image>
				<!-- <text>個護美妝</text> -->
			</view>
			<view class="cate-item">
				<image src="/static/temp/c3.jpg"></image>
				<!-- <text>營養保健</text> -->
			</view>
			<view class="cate-item">
				<image src="/static/temp/c4.jpg"></image>
				<!-- <text>家居廚衛</text> -->
			</view>
			<view class="cate-item">
				<image src="/static/temp/c5.jpg"></image>
				<!-- <text>速食生鮮</text> -->
			</view>
			<view class="cate-item">
				<image src="/static/temp/c6.jpg"></image>
				<!-- <text>環球美食</text> -->
			</view>
			<view class="cate-item">
				<image src="/static/temp/c7.jpg"></image>
				<!-- <text>個護美妝</text> -->
			</view>
			<view class="cate-item">
				<image src="/static/temp/c8.jpg"></image>
				<!-- <text>營養保健</text> -->
			</view>
			<!-- <view class="cate-item">
...
<script>
	...
	import { addWithdrawAccount} from '@/utils/api';
