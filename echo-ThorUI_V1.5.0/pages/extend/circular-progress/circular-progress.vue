<template>
	<view class="container">
		...
		<view class="tui-progress-box" v-if="status[0]">
			...
			<tui-circular-progress progressColor="#ff7900" fontColor="#ff7900" :percentage="30"></tui-circular-progress>
			<tui-circular-progress progressColor="#EB0909" fontColor="#EB0909" :percentage="80"></tui-circular-progress>
		...
		<view class="tui-progress-box" v-if="status[1]">
			<tui-circular-progress :fontShow="false" progressColor="#ff7900" fontColor="#ff7900" defaultColor="rgba(255,121,0,0.1)"
			 :percentage="50"></tui-circular-progress>
			<tui-circular-progress percentText="拼团" progressColor="#EB0909" fontColor="#EB0909" defaultColor="rgba(235,9,9,0.1)"
			 :percentage="80"></tui-circular-progress>
			<tui-circular-progress percentText="投标" progressColor="#19be6b" fontColor="#19be6b" defaultColor="rgba(25,190,107,0.1)"
			 :percentage="80"></tui-circular-progress>
		</view>
		...
		<view class="tui-progress-box" v-if="status[2]">
			<tui-circular-progress progressColor="#ff7900" fontColor="#5677fc" gradualColor="#5677fc" :percentage="60"></tui-circular-progress>
			<tui-circular-progress :defaultShow="false" progressColor="#EB0909" fontColor="#EB0909" gradualColor="#ff7900" :percentage="80"></tui-circular-progress>
			<tui-circular-progress  progressColor="#EB0909" fontColor="#EB0909" gradualColor="#ff7900"
			 :percentage="100"></tui-circular-progress>
		</view>
		...
		<view class="tui-progress-box" v-if="status[3]">
			...
			<tui-circular-progress :percentage="60" :diam="90" :lineWidth="8" :fontSize="18"></tui-circular-progress>
		...
		<view class="tui-progress-box" v-if="status[4]">
			<tui-circular-progress :percentage="progress" counterclockwise activeMode="forwards"></tui-circular-progress>
		...
		<view class="tui-progress-box" v-if="status[5]">
			<tui-circular-progress :fontShow="false" :percentage="40"  :sAngle="sAngle" :diam="240" :height="130"  :lineWidth="12" progressColor="#19be6b" fontColor="#19be6b" defaultColor="rgba(25,190,107,0.1)"  @change="change">
