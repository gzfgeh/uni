<template>
	<view class="container">
		<view class="tui-back">
			<tui-icon name="back" color="#fff" :size="30" @click="back"></tui-icon>
		...
		<tui-image-cropper custom :lockRatio="lockRatio" :edgeColor="edgeColor" :startCutting="startCutting" :rotateAngle="rotateAngle"
		 :lockWidth="lockWidth" :lockHeight="lockHeight" :disableRotate="disableRotate" :limitMove="limitMove" :imageUrl="imageUrl"
		 @cropper="cropper"></tui-image-cropper>
