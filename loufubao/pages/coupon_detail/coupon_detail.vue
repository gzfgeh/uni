...
<script>
	...
	import { BASE_IMAGE_URL,basic,couponView } from "@/utils/api";
    ...
    export default {
		...
		onLoad () {
			...
			console.log(goodsID);
			this.val = "http://m.kaikaibao.com.cn/lccx2/index.html#/pages/service_confirm/service_confirm";
			setTimeout(() => {
