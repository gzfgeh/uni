...
<style>
	...
	.name{color:rgba(0,0,0,0.8); font-size: 28upx; margin-top: 18upx; margin-bottom: 20upx;}
	.info{color: #FF5269; font-size: 40upx; }
	.text{color:rgba(0,0,0,0.8); font-size: 24upx;}
	.time{color:rgba(0,0,0,0.8); font-size: 24upx; margin-top: 40upx;}
	.img{
		width: 364upx;
		height: 364upx;
		margin-bottom: 26upx;
