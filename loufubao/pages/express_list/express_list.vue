	...
	<view>
		...
		<div class="header-bar header-search">
			<div class="header-left" onclick="mui.back();">
				<img src="../../static/img/kuaidi_close.png" mode="widthFix"/>
			</div>
			<form class="header-title color">
				<img class="left-img" src="../../static/img/kuaidi_search.png" mode="widthFix">
				<input class="search-input" id="searchText" type="search" />
				<span class="right-img" id="scanCol" onclick="scanQrCode()">
					<img  src="../../static/img/kuaidi_scan.png" mode="widthFix">
				</span>
			</form>
		</div>
		
		<ul class="express-list" style="margin-top: 80upx;">
