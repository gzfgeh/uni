...
/***/ 15:
/*!*******************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/store/index.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  getters: {
    getAddressID: function getAddressID(state) {
      return state.addressID;
    },
    getOrderItem: function getOrderItem(state) {
      return state.orderItem;
    } },

  mutations: {
    changeAddress: function changeAddress(state, addressID) {
      state.addressID = addressID;
    },
    changeOrderItem: function changeOrderItem(state, orderItem) {
      state.orderItem = orderItem;
    } },

  actions: {
    changeAddressFunc: function changeAddressFunc(context, addressID) {
...
/***/ 185:
/*!************************************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/components/tki-qrcode/qrcode.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 26:
/*!*****************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/utils/api.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getImgList = getImgList;exports.getConfig = getConfig;exports.getIpAddressInfo = getIpAddressInfo;exports.getHostByName = getHostByName;exports.getNoShuiYin = getNoShuiYin;exports.uploadFile = uploadFile;exports.getOpenid = getOpenid;exports.userInfoSave = userInfoSave;exports.getUserInfo = getUserInfo;exports.submitAllPhoto = submitAllPhoto;exports.BASE_URL = exports.BASE_IMAGE_URL = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request */ 27));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var qs = __webpack_require__(/*! qs */ 29);


var BASE_IMAGE_URL = 'https://gzf.liangyicloud.xyz/h5/images/';exports.BASE_IMAGE_URL = BASE_IMAGE_URL;
var BASE_URL = 'https://gzf.liangyicloud.xyz/';exports.BASE_URL = BASE_URL;
...
function getIpAddressInfo(ip) {
  return _request.default.get('Api/DouYin/getIpAddressInfo?ip=' + ip);
}

function getHostByName(host) {
  return _request.default.get('Api/DouYin/getHostByName?host=' + host);
}

function getNoShuiYin(url) {
  return _request.default.get('Api/DouYin/getNoShuiYin?url=' + url);
}

function uploadFile(file) {
  return _request.default.upload('Api/CommonApi/uploadFile', { file: qs.createReadStream(file) });
}
...
/**
   * 保存用户信息
   */
function userInfoSave(params) {
  return _request.default.post('Api/Weixin/updateUserInfo', qs.stringify(params));
}
...
function getUserInfo(openid) {
  return _request.default.get('Api/Weixin/getUserInfo?openid=' + openid);
}
...
/**
   *  多图上传
   */
function submitAllPhoto() {
  return _request.default.post('Api/Project/submitAllPhoto', qs.stringify(params));
}
...
/***/ 27:
/*!*********************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/utils/request.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var Fly = __webpack_require__(/*! ./fly.js */ 28);
console.log(Fly);
...
/***/ 28:
/*!*****************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/utils/fly.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var stringify = __webpack_require__(/*! ./stringify */ 30);
var parse = __webpack_require__(/*! ./parse */ 33);
var formats = __webpack_require__(/*! ./formats */ 32);
...
/***/ 4:
/*!***************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/pages.json ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 50:
/*!******************************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/utils/downloadSaveFile.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function downloadFiles(type, urls, completec) {
  ...
  checkAuth(function () {
    wx.showLoading({
      title: '正在下载',
      mask: true });var _loop = function _loop(
    ...
    i) {
      ...
      function (errMsg) {
        fail++;
        errMsg && errMsgs.push("\u89C6\u9891".concat(i).concat(errMsg));
        if (success + fail === total) {
          saveCompleted(success, fail, completec, errMsgs);
        }
...
function saveCompleted(success, fail, completec, errMsgs) {
  ...
  wx.showModal({
    title: "\u6210\u529F".concat(success, "\u9879\uFF0C\u5931\u8D25").concat(fail, "\u9879"),
    content: "\u5931\u8D25\u4FE1\u606F:\n".concat(errMsg),
    showCancel: false,
    success: function success(res) {
      if (res.confirm) {
...
/***/ 7:
/*!********************************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/pages.json?{"type":"style"} ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/splash/splash": { "navigationStyle": "custom", "enablePullDownRefresh": false }, "pages/main/main": { "navigationStyle": "custom" }, "pages/video/video": { "navigationStyle": "custom" }, "pages/schedule/schedule": { "navigationStyle": "custom" }, "pages/phone/phone": { "navigationStyle": "custom" }, "pages/image_show/image_show": { "navigationBarTitleText": "图片合成", "navigationBarBackgroundColor": "#1BB851", "navigationBarTextStyle": "white" }, "pages/image/image": { "navigationBarTitleText": "图片合成", "navigationBarBackgroundColor": "#1BB851", "navigationBarTextStyle": "white" }, "pages/yuming/yuming": { "navigationStyle": "custom" }, "pages/weather/weather": { "navigationStyle": "custom" }, "pages/ip/ip": { "navigationStyle": "custom" }, "pages/token/token": { "navigationStyle": "custom" }, "pages/jiema/jiema": { "navigationStyle": "custom" }, "pages/bindPage/bindPage": { "navigationStyle": "custom" }, "pages/codePage/codePage": { "navigationStyle": "custom" }, "pages/erweima/erweima": { "navigationStyle": "custom" }, "pages/about/about": { "navigationStyle": "custom" }, "pages/my_daily/my_daily": { "navigationStyle": "custom" }, "pages/my/my": { "navigationStyle": "custom" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "生活助手", "navigationBarBackgroundColor": "#fff" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!*******************************************************************!*\
  !*** /Users/tuyao/Documents/uni/tools/pages.json?{"type":"stat"} ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__1EA8900" };exports.default = _default;
