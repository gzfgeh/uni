    ...
    var plugintest =
        {
            ...
            PluginXjqxFunction : function (Argus1, Argus2, Argus3, Argus4, successCallback, errorCallback )
            {
                var success = typeof successCallback !== 'function' ? null : function(args)
                    {
                        successCallback(args);
                ...
                return B.exec(_BARCODE, "PluginXjqxFunction", [callbackID, Argus1, Argus2, Argus3, Argus4]);
            },
            PluginXcqxFunction : function (Argus1, Argus2, Argus3, Argus4, successCallback, errorCallback )
            {
                var success = typeof successCallback !== 'function' ? null : function(args)
                    {
                        successCallback(args);
                ...
                return B.exec(_BARCODE, "PluginXcqxFunction", [callbackID, Argus1, Argus2, Argus3, Argus4]);
            },
