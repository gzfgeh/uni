<template>
	<view class="contain">
		<div class="row item_wrap">
			<span>*</span>
			<img src="https://mall.baobaoloufu.com/build/images/img-login/louYuJoinBuildingName.png" mode="widthFix">
			<input type="text" placeholder="楼宇名称" v-model="louYuJoinBuildingName"/>
		</div>
		...
		methods: {
			async joinus(){
				...
				let params = {
					...
					louYuJoinBuildingName: this.louYuJoinBuildingName,
