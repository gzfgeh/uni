	...
	<view class="container">
		<view class="page-body uni-content-info">
			<view class='cropper-content'>
				<view class="uni-corpper row_center" :style="'width:'+cropperInitW+'px;height:'+cropperInitH+'px;background:#000'">
...
<script>
	import { BASE_IMAGE_URL,updateUserInfo} from '@/utils/api'
	
	let sysInfo = uni.getSystemInfoSync();
	let SCREEN_WIDTH = sysInfo.screenWidth;
	let SCREEN_HEIGHT = sysInfo.screenHeight-44;
	let PAGE_X, // 手按下的x位置
		PAGE_Y, // 手按下y的位置 
				...
				ctx.draw(true, () => {
					...
					uni.canvasToTempFilePath({
						...
						success: function (res) {
							...
							uni.uploadFile({
								url: BASE_IMAGE_URL+ 'User/User/updateUserInfo', //仅为示例，非真实的接口地址
								...
								success: (uploadFileRes) => {
									...
									if(uploadFileRes.data){
										...
										if(fileRes.status == 1){
											uni.setStorageSync("userInfo", fileRes.data.userInfo);
											uni.navigateBack({
												delta: 1
											});
