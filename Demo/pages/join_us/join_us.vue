...
<style>
.item_wrap{height: 300upx; width: 96%; margin: 10upx 2%;position: relative;color: #FFF; font-size: 32upx;}
.item_wrap img{position: absolute;top: 0upx; left: 0upx; width: 100%; height: 100%; z-index: -1;}
</style>
