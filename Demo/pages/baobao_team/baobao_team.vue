	...
	<view>
		<block  v-for="(item,index) in list" :key="index" >
			<div class="row item_wrap" @click="contactUs(index)">
				<img :src="(item.courierImg?item.courierImg:'../../static/img/mtyou_icon.png')" mode="aspectFill">
...
.item_wrap img{width: 160upx; margin-right: 20upx; border-radius: 50%; height: 160upx;}
